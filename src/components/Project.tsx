...
const Project = ({ project }: project) => {
    return (
        <div className='flex flex-col items-center  w-full sm:w-[30%]  bg-[#1A1A1A] p-4 rounded-2xl max-h-[500px] space-y-4 overflow-hidden shadow-sm shadow-[#d3e97a] hover:scale-105 transition-all delay-75 ease-linear'>
